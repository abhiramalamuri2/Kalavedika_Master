...
import 'package:kalavedika/screens/videoWork_screen.dart';
import 'video_screen.dart';

IconData p1 = FontAwesomeIcons.circle, p2 = FontAwesomeIcons.circle;

class PayVideoWork extends StatefulWidget {
  PayVideoWork({@required String this.videoID});
  final String videoID;
  @override
  _PayVideoWorkState createState() => _PayVideoWorkState();
}

class _PayVideoWorkState extends State<PayVideoWork> {
  @override
                    ...
                    FlatButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                VideoPlayerWork(videoID: widget.videoID),
                          ),
                        );
                      },
                      child: Container(
